	...
	<div class="container">
		...
		<a class="branded">
		<img src="img/COT.png" width="100" height="90">
 	</a> 
	<a class="brand">
	 <h1>Computer Laboratory Utilization</h1>
	 <div class="chmsc_nav"><font size="5" style="Bookman Old Style" color="white">Bukidnon State University</font></div>
 	</a>
<div class="time_top">	
<font color="orange">
  <?php
